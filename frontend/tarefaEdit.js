...
const contaTarefas = document.querySelector('.conta-tarefas').textContent
const main = document.querySelector(".main");

let contadorTarefa = parseInt(contaTarefas)
...
addTarefaBtn.addEventListener("click", () => {
  ...
  inputTarefa.name = `tarefa[${contadorTarefa}].tarefa`;
